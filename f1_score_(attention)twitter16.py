# -*- coding: utf-8 -*-
"""f1_score_(Attention)twitter16_experiment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18HVh0KeC2deVXq4ibQPcgS3Hc_Jm7842
"""
...
label_dict = np.load('/content/drive/My Drive/twitter15_twitter16_saved_files/twitter16_files/label_dict.npy', allow_pickle=True).item()
data = np.load('/content/drive/My Drive/twitter15_twitter16_saved_files/twitter16_files/data.npy', allow_pickle=True).tolist()
tweets = np.load('/content/drive/My Drive/twitter15_twitter16_saved_files/twitter16_files/tweets.npy', allow_pickle=True).tolist()
twitter_15_text_dict = np.load('/content/drive/My Drive/twitter15_twitter16_saved_files/twitter16_files/twitter_15_text_dict.npy', allow_pickle=True).item()
src_tweets_text = np.load('/content/drive/My Drive/twitter15_twitter16_saved_files/twitter16_files/src_tweets_text.npy', allow_pickle=True).item()
